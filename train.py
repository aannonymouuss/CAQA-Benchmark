...
TASK_PROMPTS = {p['task_name']:[p['prompt_template'],p['input_template'],p['label_map']] for p in json.load(open("prompt_and_demo/our_prompts.json"))}
...
class DataArguments:
    ...
    eval_subset: str = field(default=None, metadata={"help": "eval subset name if loading from huggingface datasets"})
